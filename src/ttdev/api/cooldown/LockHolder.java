...
public class LockHolder {
    ...
    public static void loadLocks(JavaPlugin plugin) {
        DataStore dataStore = new DataStore(plugin.getDataFolder().getPath() + "/cooldown-data.yml");
        int lockCount = dataStore.loadInteger("cooldown-count");
    ...
    public static void saveLocks(JavaPlugin plugin) {
        DataStore dataStore = new DataStore(plugin.getDataFolder().getPath() + "/cooldown-data.yml");
        dataStore.saveInteger(locks.size(), "cooldown-count");
